...
namespace OpenFin.WPF.TestHarness.ChildForms
{
    internal class WindowDirectory
    {
        ...
        {
            apps.Add(new OpenFinApp(uuid, "WPF App 1", "wpfapp1", "Here.io .NET 6 WPF Test Harness", () => new App1(), "wpf", "native"));
            apps.Add(new OpenFinApp(uuid, "WPF App 2", "wpfapp2", "Here.io .NET 6 WPF Test Harness", () => new App2(), "wpf", "native"));
            apps.Add(new OpenFinApp(uuid, "WPF App 3", "wpfapp3", "Here.io .NET 6 WPF Test Harness", () => new App3(), "wpf", "native"));
        }
    }
}

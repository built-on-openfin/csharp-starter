...
It will run the main form and that will instantiate the workspace class which launches Here.io Workspace and connects it to your native app.
...
* restore nuget packages.
* debug the project Here.io .WPF.TestHarness or start without debugging.

It will run the main WPF form and that will instantiate the workspace class which launches Here.io Workspace (if it isn't already running) and connects it to your native app.
...
You can save a workspace by using the workspace menu in the Here.io Workspace Browser or you can type the following into home /w myworkspace.
